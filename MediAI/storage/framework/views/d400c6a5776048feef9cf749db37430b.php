        ...
        <div class="row mt-5">
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <address class="m-0 text-secondary">Antonine University, Antonine Str, Baabda, Lebanon</address>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-5">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="">+961 05 927 000</a>
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <hr class="w-75 mb-3 border-dark-subtle">
                    <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="mailto:contactus@mediai.com">contactus@mediai.com</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\mediAI\resources\views/Main/contact_us.blade.php ENDPATH**/ ?>