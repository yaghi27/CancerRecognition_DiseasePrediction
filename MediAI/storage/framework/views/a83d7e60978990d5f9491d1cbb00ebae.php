...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/material-components-web.min.css')); ?>">
        ...
        <nav style="height: 6vh !important; padding: 5px 20px;" class="navbar navbar-expand-md navbar-primary bg-mediai">
            ...
            <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarsExampleDefault">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <?php if(request()->url() === route('disease_prediction')): ?>
                            <a class="nav-link" style="font-weight: bold; cursor: default;">Disease prediction</a>
                        <?php else: ?>
                            <a class="nav-link" href="<?php echo e(route('disease_prediction')); ?>">Disease prediction</a>
                        <?php endif; ?>
                    </li>

                    <li class="nav-item">
                        <?php if(request()->url() === route('ct_scan')): ?>
                            <a class="nav-link" style="font-weight: bold; cursor: default;">CT Scan</a>
                        <?php else: ?>
                            <a class="nav-link" href="<?php echo e(route('ct_scan')); ?>">CT Scan</a>
                        <?php endif; ?>
                    </li>

                    <li class="nav-item">
                        <?php if(request()->url() === route('history')): ?>
                    ...
                    <li class="nav-item">
                        <?php if(request()->url() === route('contact_us')): ?>
...
<?php /**PATH C:\wamp64\www\mediAI\resources\views/layouts/main.blade.php ENDPATH**/ ?>