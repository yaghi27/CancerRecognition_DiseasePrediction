        ...
        <div class="container-fluid" style="height: 92vh; background-color: hsl(0, 0%, 96%)">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
              <img src="{{ asset('img/loginWallPaper.webp') }}" class="img-fluid" alt="Sample image">
            </div>
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              {{-- <form>
                ...
                <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                  ...
                  <a href="{{ route('login/google') }}" ><button type="button" class="btn btn-mediai btn-floating mx-1">
